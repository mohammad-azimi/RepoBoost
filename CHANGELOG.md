...
* Added `repoboost report` command
* Added Markdown audit report generation
* Added `--output` support for saving reports to a file
* Added `--missing-only` option for report output
* Added recommendations section to generated Markdown reports
* Added next-step suggestions to generated Markdown reports
* Added tests for Markdown report generation

### Changed

* Updated package version to `0.1.2`
* Updated documentation for Markdown report generation
